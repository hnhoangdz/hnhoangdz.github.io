...
- Trong thuật toán Decision Tree, việc tiền xử lí như _feature scaling (normalization)_  là không cần thiết bởi vì thuật toán sẽ đi hỏi từng thuộc tính.
...
- Decision Tree yêu cầu khá nhiều hyper-parameters nên cách tốt nhất đó là sử dụng các phương pháp tuning để lựa chọn ra các hyper-paramters tốt nhất. Về các phương pháp tuning hyper-parameters mình sẽ trình bày 1 bài riêng.
