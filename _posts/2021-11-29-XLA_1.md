...
#### 7.1.2. Thực hành thuật toán

Các bước thực hiện: 

- B1: Thực hiện tính toán tích chập với 2 bộ lọc $f_x, f_y$ và thu được $G_x,G_y$ tương ứng. 

- B2: Tính xấp xỉ đạo hàm bằng cách:
